...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1><a href="index.html">i<span>Solution</span> <small>Show Product</small></a></h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content" >
    <div class="content_resize" width=2000px>
    <h2 align=center>Show Product</h2>
	<%@page import="java.sql.ResultSet"%>
<%@page import="java.sql.Statement"%>
<%@include file="db.jsp" %>
<table border="1">
<th>product id</th><th>product name</th><th>product price</th><th>product category</th><th>product company</th><th>images</th><th>Update</th><th>Delete</th><th>Upload image</th>
<%
...
if(rs.next()){
	...
	<td><input type="text" name="name" value="<%=rs.getString("product_name") %>"></td>
	<td><input type="number" name="price" value="<%=rs.getInt("product_price") %>"></td>
	
<td><input type="text" name="cat" value="<%=rs.getString("product_category") %>"></td>
<td><input type="text" name="comp" value="<%=rs.getString("product_company") %>"></td>
<td><img src="<%=iname%>" alt="noimage" width=100px height=100px/></td>
<td><input type="submit" value="update"></td>
</form>
		<td><a href="Delete.jsp?id=<%=id %>">delete</a></td>
		<td><a href="upload.jsp?id=<%=id%>">Upload Image</a></td>
		</tr>
